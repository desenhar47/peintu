        ...
        <div class="col-md-6 product-content">
          {block name='page_header_container'}
            {block name='page_header'}
              <h1 class="h1-main productpage_title" itemprop="name">{block name='page_title'}{$product.name}{/block}</h1>
            {/block}
          {/block}
	...
	<section class="product-tabcontent">	
	 {block name='product_tabs'}	
		<div class="tabs">
                ...
                <li class="nav-item">
                  <a class="nav-link {if !$product.description} active{/if}" data-toggle="tab" href="#rating">{l s='rating' d='Shop.Theme.Global'}</a>
                </li>

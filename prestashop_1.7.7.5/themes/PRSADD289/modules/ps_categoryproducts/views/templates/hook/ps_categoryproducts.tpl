...
<section class="productscategory-products clearfix">
	...
	{if $products|@count == 1}
		{l s='%s other product in the same category:' sprintf=[$products|@count] d='Shop.Theme.Global'}
	{else}
		{l s='%s other products in the same category:' sprintf=[$products|@count] d='Shop.Theme.Global'}
	{/if}
	</h2>
  <div id="spe_res">
	<div class="products">

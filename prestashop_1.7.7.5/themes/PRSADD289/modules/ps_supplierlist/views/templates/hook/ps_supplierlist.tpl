...
<div id="suppliers_list" class="block">
  <h4 class="block_title hidden-md-down">
  	{if $display_link_supplier}<a href="{$page_link}" title="{l s='Suppliers' d='Shop.Theme.Global'}">{/if}
      {l s='Suppliers' d='Shop.Theme.Global'}
  ...
  <div id="suppliers_list_toggle" class="block_content collapse">
    ...
    {else}
      <p>{l s='No supplier' d='Shop.Theme.Global'}</p>
    {/if}
  </div>
</div>

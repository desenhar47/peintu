...
<div class="panel"><h3><i class="icon-list-ul"></i> {l s='Slides list' d='Shop.Theme.Global'}
	<span class="panel-heading-action">
		<a id="desc-product-new" class="list-toolbar-btn" href="{$link->getAdminLink('AdminModules')}&configure=tm_leftbanner&addSlide=1">
			<span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="{l s='Add new' d='Shop.Theme.Global'}" data-html="true">
								...
								{if $slide.is_shared}
									<div>
										<span class="label color_field pull-left" style="background-color:#108510;color:white;margin-top:5px;">
											{l s='Shared slide' d='Shop.Theme.Global'}
										</span>
									</div>
								{/if}
							</h4>

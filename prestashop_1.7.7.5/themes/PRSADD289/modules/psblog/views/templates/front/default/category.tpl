...
{block name='content'}
	...
	<div id="blog-category" class="blogs-container">
		<div class="inner">	
						...
						{if $category->image}
							<div class="row">
								...
								<div class="col-xs-12 col-sm-12 col-lg-8 category-info caption">
									<h1 class="h1">{$category->title|escape:'html':'UTF-8'}</h1>
			...
			<div class="childrens">
				<h3 class="subcategories-title">{l s='Childrens' d='Shop.Theme.Global'}</h3>
			...
			{if count($leading_blogs)+count($secondary_blogs)}
				<div class="Recnet-blog">
					<h3 class="Recent-title h3">{l s='Recent blog posts' d='Shop.Theme.Global'}</h3>

...
class MigrateData
{
    ...
    public function retrieveOldData()
    {
        ...
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'tmfootercmsblockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'tmfootercmsblockinfo_lang` il ON il.`id_tmfootercmsblockinfo` = i.`id_tmfootercmsblockinfo`'
        );
    ...
    public function insertData()
    {
        ...
        $tmfootercmsblockinfo->text = reset($customTexts);

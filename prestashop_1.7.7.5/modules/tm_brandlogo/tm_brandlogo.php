...
class Tm_Brandlogo extends Module implements WidgetInterface
{
    protected $templateFile;

    public function __construct()
    {
        $this->name = 'tm_brandlogo';
        ...
        $this->description = $this->trans(
            'Displays manufacture as slider or grid in the central column of your homepage.',
            array(),
            'Modules.Brandlogo'
        );
        $this->ps_versions_compliancy = array('min' => '1.7.0.0', 'max' => _PS_VERSION_);

        $this->templateFile = 'module:tm_brandlogo/views/templates/hook/tm_brandlogo.tpl';
    }

    public function install()
    {
        Configuration::updateValue('TM_BRAND_SLIDER', 1);
        Configuration::updateValue('TM_BRAND_NAME', 0);
    ...
    public function uninstall()
    {
        return parent::uninstall()
            && Configuration::deleteByName('TM_BRAND_SLIDER')
            && Configuration::deleteByName('TM_BRAND_NAME');
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitTmBlockBrandLogos')) {
            
			Configuration::updateValue('TM_BRAND_SLIDER', (int)(Tools::getValue('TM_BRAND_SLIDER')));
			Configuration::updateValue('TM_BRAND_NAME', (int)(Tools::getValue('TM_BRAND_NAME')));
			$this->_clearCache('*');
    ...
    public function renderForm()
    {
        ...
        $helper->submit_action = 'submitTmBlockBrandLogos';
    ...
    {
        return array(
            'TM_BRAND_SLIDER' => (int)Tools::getValue('TM_BRAND_SLIDER', Configuration::get('TM_BRAND_SLIDER')),
            'TM_BRAND_NAME' => (int)Tools::getValue('TM_BRAND_NAME', Configuration::get('TM_BRAND_NAME')),
        );
    }
    ...
    public function getWidgetVariables(
        ...
        return array(
            ...
            'slider' => Configuration::get('TM_BRAND_SLIDER'),
			'brandname' => Configuration::get('TM_BRAND_NAME'),
    ...
    public function renderWidget(
        ...
        $cacheId = $this->getCacheId('tm_brandlogo');
